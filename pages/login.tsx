                        ...
                        <div className='flex justify-between mb-10'>
                            ...
                            <div className='border-l-[1px] mr-96'>
                                ...
                                <div className='m-5 ml-10'>
                                    <input className='rounded-sm pl-2 h-12 w-full bg-customize-text border-b-[1px] border-customize-slate200/50' onChange={this.handleChange} type="email" name="email" required placeholder='Эл.почта' />
                                </div>
                                <div className='m-5 ml-10'>
