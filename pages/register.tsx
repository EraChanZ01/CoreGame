                ...
                <Layout>
                    ...
                    <div className='grid grid-cols-2 mx-56 my-10 border-b-[1px] border-customize-slate200/50'>
                        <div className="col-span-2 flex flex-col mt-5 " >
                            ...
                            <input className=" rounded-sm my-2 py-3 w-full bg-customize-text border-b-[1px] border-customize-slate200/50" onChange={this.handleChange} placeholder='' name="email" type="email" required />
