...
export default function InputCategories({ category,VerificationInput }) {
    
    
    const inputRef = useRef(null)

    const [input, setInput] = useState({name: category.get("name"), id: category.get("id"), checked: inputRef.current.checked})
